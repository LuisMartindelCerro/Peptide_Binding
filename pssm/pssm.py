...
parser.add_argument("-b", action="store", dest="beta", type=float, default=100.0,help="Weight on pseudo count (default: 50.0)")
...
parser.add_argument("-z", dest="evaluation_file", required=True, help="Peptides file (peptide + score)")
...
data_dir = "/mnt/c/Users/Xavi/Documents/Master_in_Bioinformatics_and_Systems_Biology/June_2025/algorithms/code/data/"
...
for position in range(0, peptide_length):
	...
	#c_matrix[position][peptide[position]] += XX        
...
# Write out PSSM in Psi-Blast format to file
file_name = "w_matrix_mhc2_fold0_test"
to_psi_blast_file(w_matrix, file_name)
